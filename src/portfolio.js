...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building large-scale Web applications with JavaScript / Reactjs / Nodejs / ASP.NET / Python and some other cool libraries and frameworks."
  ),
  resumeLink:
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("⚡ Develop high performance backend APIs using ASP.NET / Node.js"),
    emoji(
